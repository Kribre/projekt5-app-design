...
function barSize() {
  document.getElementById("rain1").style.width =
    document.getElementById("baggrund").offsetWidth + "px";
  document.getElementById("rain1").style.width =
    document.getElementById("baggrund").offsetWidth + "px";
...
function parrrrrrrentScreen() {
  var testDiv = document.getElementById("baggrund");
  document.getElementById("infoKnap").style.left =
    testDiv.offsetLeft - document.getElementById("infoKnap").offsetWidth + "px";
